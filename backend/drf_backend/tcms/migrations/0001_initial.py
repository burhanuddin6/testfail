# Generated by Django 5.0.6 on 2024-07-21 07:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_case_result_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tcms.testcaseresults')),
            ],
        ),
        migrations.AddField(
            model_name='testcase',
            name='latest_result_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='tcms.testcaseresults'),
        ),
        migrations.CreateModel(
