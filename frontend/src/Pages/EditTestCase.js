        ...
        <form className="test-case-form" onSubmit={handleSubmit}>
          ...
          <div className="test-case-form-group">
            ...
            <select
              ...
              className="test-case-select"
            >
              {Object.entries(choices.automation_type).map(([value, label]) => (
                <option key={value} value={value}>
                  {label}
                </option>
              ))}
          ...
          <div className="test-case-form-group">
            <label htmlFor="file" className="test-case-label">
              File
            </label>
            <input
              type="file"
              id="file"
              onChange={handleFileChange}
              className="test-case-file"
            />
          </div>

          <div className="test-case-form-group">
            <button type="submit" className="test-case-submit">
              Save
            </button>
